...
static constexpr HookPoint kHpSelectFilterHouse1    = {0x006DA78D, 5};
static constexpr HookPoint kHpSelectFilterType      = {0x00732C30, 5};
static constexpr HookPoint kHpSelectFilterHouse2    = {0x00732337, 5};
static constexpr HookPoint kHpSelectFilterHouse3    = {0x0073238E, 5};
static constexpr HookPoint kHpSelectFilterHouse4    = {0x00732457, 5};
static constexpr HookPoint kHpSelectFilterHouse5    = {0x007329DB, 5};
